...
def info_box():
    messagebox.showinfo(
        "Info Box", "This is an Info Box"
    )  # First Arg is title, Second Arg is the info.


def error_box():
    messagebox.showerror(
        "Error Box", "This is an Error Box"
    )  # showerror displays error box


def warning_box():
    messagebox.showwarning(
        "Warning Box", "This is a Warning Box"
    )  # showwarning displays warning box
