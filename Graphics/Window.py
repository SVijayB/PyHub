...
window.iconbitmap("assets/Graphics/favicon.ico")        # Setting the icon for the window.
window.configure(bg="blue")                             # Added Background of the window as blue.
image = PhotoImage(file="assets/Graphics/Random.PNG")   # Gets Image from location.
